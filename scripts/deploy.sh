...
# Amplify-compatible variables (bypasses "AWS_" prefix restriction)
WORLDLENS_AWS_REGION=$REGION
WORLDLENS_AWS_ACCESS_KEY_ID=$ACCESS_KEY_ID
WORLDLENS_AWS_SECRET_ACCESS_KEY=$SECRET_ACCESS_KEY
